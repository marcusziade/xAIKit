...
<body>
    ...
    <section class="platforms">
        <div class="container">
            ...
            <p style="margin-top: 20px; color: var(--xai-gray);">iOS 16+ • macOS 13+ • tvOS 16+ • watchOS 9+ • visionOS 1+</p>
        </div>
    </section>
...
<span class="comment">// Create a chat request</span>
<span class="keyword">let</span> request = <span class="function">ChatRequest</span>(
    model: .grokBeta,
    messages: [
        <span class="function">Message</span>(role: .user, content: <span class="string">"Explain quantum computing"</span>)
    ]
)

<span class="comment">// Get AI response</span>
<span class="keyword">let</span> response = <span class="keyword">try await</span> client.chat.<span class="function">completions</span>(request)
<span class="function">print</span>(response.choices.first?.message.content ?? <span class="string">""</span>)</code></pre>
    ...
    <footer>
        <div class="container">
            <p>&copy; 2024 xAIKit. Built with Swift and ❤️</p>
